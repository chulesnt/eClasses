...
@WebServlet(name = "ConsultarFotoAluno", urlPatterns = {"/aluno/foto/consultar"})
public class ConsultarFotoAluno extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			ps = c.prepareStatement("SELECT foto FROM aluno WHERE \"id-aluno\" = ?");
