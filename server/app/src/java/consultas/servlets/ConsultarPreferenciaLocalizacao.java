...
@WebServlet(name = "ConsultarPreferenciaLocalizacao", urlPatterns = {"/consultar/preferencialocal"})
public class ConsultarPreferenciaLocalizacao extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			xml = r.consultarPreferenciaLocalizacao(id);
			res.setStatus(200);
			out.println(xml);
			c.close();
