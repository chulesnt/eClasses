...
@WebServlet(name = "MensagensEnviadasAluno", urlPatterns = {"/mensagens/enviadas/aluno"})
public class MensagensEnviadasAluno extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			List<MensagensModel> r = mr.mensagensEnviadasAluno(id);
